...
export default function AdminDashboard() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900">
            {/* Navbar */}
            <nav className="bg-white border-b border-slate-200 px-8 py-4 flex justify-between items-center shadow-sm sticky top-0 z-20">
                <div className="flex items-center gap-2">
                    <LayoutDashboard className="text-blue-700" size={24} />
                    <h1 className="text-xl font-black text-slate-900 tracking-tight">Thriveni Admin</h1>
                </div>
                <div className="flex items-center gap-6">
                    <div className="hidden md:flex gap-6 text-sm font-bold text-slate-600">
                        <span className="cursor-pointer hover:text-blue-700 transition-colors">Nominations</span>
                        <span className="text-blue-700 border-b-2 border-blue-700 pb-1">Feedback Hub</span>
                    </div>
                    <SignOutButton />
                </div>
            </nav>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                        ...
                        {loading ? (
                            <div className="flex flex-col items-center py-10 text-slate-400">
                                ...
                                <p className="text-sm font-bold">Fetching Sessions...</p>
                            </div>
                        ) : sessions.length === 0 ? (
